add_custom_target(iso ALL
    ...
    COMMAND ${CMAKE_COMMAND} -E echo "menuentry \"oscore\" {" > ${CMAKE_BINARY_DIR}/isodir/boot/grub/grub.cfg
    COMMAND ${CMAKE_COMMAND} -E echo "    multiboot /boot/kernel.elf" >> ${CMAKE_BINARY_DIR}/isodir/boot/grub/grub.cfg
    ...
    COMMAND grub-mkrescue -o ${CMAKE_BINARY_DIR}/oscore.iso ${CMAKE_BINARY_DIR}/isodir --quiet
